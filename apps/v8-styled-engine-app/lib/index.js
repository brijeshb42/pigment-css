...
export var Hello = styled("div")({
  __css: "@custom-media --md (width>=40rem);.current{color:var(--color-text-primary);background:red}.current .primary{background:#00f}@media (--md){.current{color:#00f}}@media (width>=40rem){.current{color:red}}",
  classes: {}
});
export var Hello2 = styled("div")({
  __css: "@custom-media --md (width>=40rem);.current{color:var(--color-text-primary);background:red}.current .primary{background:#00f}",
  classes: {}
});
